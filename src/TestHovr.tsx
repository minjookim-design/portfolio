...
export function TestHovr() {
  ...
  try {
    ...
    console.error('[TestHovr] Failed to load or parse markdown:', error)
    return <TestHovrErrorPanel error={error} rawPreview={hovrMarkdown} />
  }
}
