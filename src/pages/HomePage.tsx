 ...
 * Nested project overlays: `/hovr`, `/piik-ai`. Previous homepage lives at `/test-home`.
 */
...
/** Production home at `/` — uses {@link HOME_PAGE_PRODUCTION_CONFIG}. Project routes render as overlay Outlet. */
