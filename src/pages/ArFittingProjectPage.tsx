          ...
          >
            ...
            >
              <React.Fragment key={AR_FITTING_META_ROWS[0].label}>
                ...
                <span style={{ fontWeight: 700, paddingBottom: 8 }}>{AR_FITTING_META_ROWS[0].value}</span>
              </React.Fragment>
              ...
              {AR_FITTING_META_ROWS.slice(1).map(({ label, value }, i) => (
                <React.Fragment key={label}>
                  ...
                  <span style={{ fontWeight: 700, paddingBottom: i < AR_FITTING_META_ROWS.length - 2 ? 8 : 0 }}>{value}</span>
                </React.Fragment>
              ))}
            </div>
          </div>
