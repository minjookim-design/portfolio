...
export const AR_FITTING_META_ROWS = [
  ...
  {
    label: 'Tools',
    value: 'Figma, Principle, Blender',
  },
  {
    label: 'Recognition',
    value:
      'RGD Student Award 2024 — Honourable Mention, Accessible Design · Indigo Design Award 2024 — Bronze, UX / Interface & Navigation',
  },
]
