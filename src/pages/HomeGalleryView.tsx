/**
 * Production gallery homepage at `/` — three-column intro / thumbs / hover previews.
 */
...
export type HomeGalleryExperienceConfig = {
...
export function HomeGalleryView({ config }: { config: HomeGalleryExperienceConfig }) {
  ...
  return (
    ...
    >
      <HomeGalleryViewInner config={config} />
    </ProjectListHoverPreviewProvider>
  )
}

function HomeGalleryViewInner({ config }: { config: HomeGalleryExperienceConfig }) {
