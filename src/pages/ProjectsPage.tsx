...
export function ProjectsPage() {
  return (
    <>
      <div
        className="theme-surface-transition flex h-screen min-h-0 w-full max-w-full flex-col overflow-x-hidden overflow-y-auto snap-y snap-mandatory items-center gap-8 bg-[#faf7f0] px-4 pb-[calc(20vh+5.5rem)] pt-[10vh] max-md:pb-[calc(20vh+5.5rem+env(safe-area-inset-bottom,0px))] [&::-webkit-scrollbar]:hidden scrollbar-width-none md:px-0"
      >
